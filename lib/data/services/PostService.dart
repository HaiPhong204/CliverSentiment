...
class PostService extends GetConnect {
  ...
  Future<Response> getPosts({String? search, int? minPrice, int? maxPrice, int? deliveryTime, String? filter, int? categoryId, int? offset, int? limit}) {
    ...
    String prm7 = offset != null ? "&Offset=$offset" : '';
    String prm8 = limit != null ? "&Limit=$limit" : '';
    return get(
      "$api_url/posts?$prm1$prm2$prm3$prm4$prm5$prm6$prm7$prm8",
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': userController.userToken,
      },
