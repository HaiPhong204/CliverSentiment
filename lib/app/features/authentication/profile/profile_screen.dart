...
class ProfileScreen extends StatefulWidget {
  const ProfileScreen({super.key, this.onSave});
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  @override
  void initState() {
    userTemp = userController.currentUser.value;
    nameController = TextEditingController(text: userTemp.name);
    super.initState();
  }
      ...
      bottomNavigationBar: SizedBox(
        ...
        child: InkWellWrapper(
          ...
          onTap: () async {
            ...
            EasyLoading.show();
            await UserService.ins.updateInfoUser(user: userTemp);
            EasyLoading.dismiss();
            Get.offAllNamed(myBottomBarRoute);
          },
          child: Center(
              ...
              child: ClipRRect(
                ...
                child: GestureDetector(
                  ...
                  child: imageFile == null
                      ? Image.network(
                    userController.currentUser.value.avatar ?? 'https://haycafe.vn/wp-content/uploads/2022/02/Anh-gai-xinh-Viet-Nam.jpg',
                    height: 120,
                    width: 120,
                    fit: BoxFit.cover,
